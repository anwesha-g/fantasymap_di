...
const int stepsPerRevolution = 200;  // change this to fit the angle to move it (maybe times 2)
...
void loop() {
  ...
  if (pin8 == LOW && !pin10 == LOW) { //turn adventure of sherlock holmes green
  ...
  if (pin9 == LOW && !pin10 == LOW) { // snow white
    colorWipe(strip.Color(0, 255, 0), 20, 31, 185);
    strip.show();
  ...
  if (pin10 == LOW && dangerZone == 0) { //little mermaid
    colorWipe(strip.Color(0, 255, 0), 0, 0, 185);
    colorWipe(strip.Color(255, 0, 0), 20, 185, 231);
    strip.show();
    ...
    dangerZone = 1;
  } else if (pin10 == LOW && dangerZone == 1) {
    colorWipe(strip.Color(255, 0, 0), 0, 0, 231);
    strip.show();
  } else { // TURN OFF 
    colorWipe(strip.Color(0, 0, 0), 0, 185, 231);
    strip.show();
  }
}
